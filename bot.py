...
@client.command()
async def help():
	em = discord.Embed(title="Help", description="Still Testing", color=0x992d22).set_author(name="Help2").add_field(name='ping', value='Returns Pong!').add_field(name='echo (Insert Fart Joke here)', value='Returns what the User said').set_footer(text="These only Work in ")
